...
commander
  ...
  .option('-M, --meta <meta>', 'global user meta, will send with x-oss-meta- prefix string', createParse('meta', JSON.parse))
  .option('-H, --headers <headers>', 'global extra headers', createParse('headers', JSON.parse))
  .parse(process.argv)
